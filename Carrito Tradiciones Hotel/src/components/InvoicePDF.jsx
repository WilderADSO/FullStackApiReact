...
const InvoicePDF = () => {
  ...
  const generatePDF = () => {
    ...
    const logo = '/logo tradiciones 2.jpeg'; // Reemplazar con la ruta de tu logotipo
    ...
    doc.text('Tradiciones Café Hotel', 105, 30, null, null, 'center');
    doc.text('Parque la Inmaculada (San Roque Antioquia)', 105, 35, null, null, 'center');
    doc.text('Teléfono: 3024420050', 105, 40, null, null, 'center');
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text(`Total: $${total.toFixed(2)} $`, labelX, finalY);

    // Pie de página
    doc.setFontSize(12);
    doc.setFont('helvetica', 'italic');
    doc.setTextColor(0, 128, 0); // Verde
    doc.text('Gracias por su visita', 105, finalY + 20, null, null, 'center');
    doc.text('Por favor conserve esta factura para posibles reclamos.', 105, finalY + 30, null, null, 'center');
